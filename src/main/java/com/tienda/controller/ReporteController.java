...
public class ReporteController {
    ...
    public ResponseEntity<Resource> reporteUsuarios(@RequestParam String tipo) 
            throws IOException {
        return reporteService.generaReporte("usuario",null, tipo);        
    }
    ...
    @GetMapping("/factura")
    public ResponseEntity<Resource> reporteFactura(@RequestParam String tipo)
            throws IOException{
        return reporteService.generaReporte("factura", null, tipo);
    }
    @GetMapping("/categoria")
    public ResponseEntity<Resource> reporteCategoria(@RequestParam String tipo)
            throws IOException{
